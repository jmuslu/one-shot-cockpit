...
The app uses generated WebAudio effects plus bundled Kenney Casino Audio chip clips for the ca-ching. Kenney Casino Audio is CC0 and the license is included at `public/sounds/casino/KENNEY_CASINO_AUDIO_LICENSE.txt`. The vocal stingers are original synthetic arcade-style effects, not ripped character audio or official character voice lines.
